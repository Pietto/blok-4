...
--
-- Host: localhost
-- Gegenereerd op: 08 jun 2019 om 19:31
-- Serverversie: 5.6.37
-- PHP-versie: 5.6.31
...
--
-- Tabelstructuur voor tabel `user_input`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `user_input`
--

INSERT INTO `user_input` (`id`, `game_name`, `host_name`, `players`, `time_start`, `time_end`) VALUES
(41, 'Counterfeiters', 'olafs', 5, '04:55', '04:55');
...
--
-- AUTO_INCREMENT voor een tabel `user_input`
--
ALTER TABLE `user_input`
